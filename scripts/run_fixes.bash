#!/bin/bash
./scripts/kisz-run-in-docker.sh -g 1 python scripts/multi_config_train.py --config_path scripts/multi_configs/baseline_sweep_fix.json
...
./scripts/kisz-run-in-docker.sh -g 3 python scripts/multi_config_train.py --config_path scripts/multi_configs/baseline_sweep_qat_and_kd_fix.json
...
./scripts/kisz-run-in-docker.sh -g 6 python scripts/multi_config_train.py --config_path scripts/multi_configs/baseline_sweep_quantization_aware_train_fix.json
