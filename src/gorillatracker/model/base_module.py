        ...
        metrics |= (
            {
                ...
                "knn_macro_filter_cos": partial(knn_func, k=1, average="macro", use_filter=True, distance_metric="cosine"),
                "knn5_macro_filter_cos": partial(knn_func, k=5, average="macro", use_filter=True, distance_metric="cosine"),
                "knn_with_train_filter_cos": partial(knn_func, k=1, use_train_embeddings=True, use_filter=True, distance_metric="cosine"),
                "knn5_with_train_filter_cos": partial(knn_func, k=5, use_train_embeddings=True, use_filter=True, distance_metric="cosine"),       
