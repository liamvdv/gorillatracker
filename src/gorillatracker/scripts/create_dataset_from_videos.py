...
def get_negatives(id_frames: dict[int, list[(int, (float, float, float, float))]], min_frames: int, json_path: str) -> (dict[int, list[(int, (float, float, float, float))]], dict[int, list[int]]):
...
create_dataset_from_videos("/workspaces/gorillatracker/videos", "/workspaces/gorillatracker/data/derived_data/spac_gorillas_converted_labels_tracked", "/workspaces/gorillatracker/data/derived_data/spac_gorillas_converted_labels_cropped_faces")   
