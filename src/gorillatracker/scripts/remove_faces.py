...
def _remove_face(body_image_path: str, segmented_body_image_path: str, face_image_path: str, target_path: str) -> None:
    ...
    # make white: segmented_body_image[bbox[0][1] : bbox[1][1], bbox[0][0] : bbox[1][0]]
    segmented_body_image[bbox[0][1] : bbox[1][1], bbox[0][0] : bbox[1][0]] = 255
    cv2.imwrite(target_path, segmented_body_image)

def remove_faces(body_image_dir: str, segmented_body_image_dir: str, face_image_dir: str, target_dir) -> None:
...
if __name__ == "__main__":
    remove_faces(
        ...
        "/workspaces/gorillatracker/data/derived_data/cxl/yolov8n_gorillabody_ybyh495y/segmented_body_images_no_face",
    )