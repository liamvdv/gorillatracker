...
def test_tripletloss_online_hard():
    ...
    loss_online_hard, distance_positive_online_hard, distance_negative_online_hard  = TripletLossOnline(margin=1.0, mode="hard")(torch.stack([a, ap, n, np]), torch.tensor([0, 0, 1, 1]))
